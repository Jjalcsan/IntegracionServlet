...
public class ServletFactura extends HttpServlet{
	...
	/**
	 * El metodo doGet primero mirara que exista la sesion. Si existe, mostrara la factura final del pedido, indicando el usuario que la realiza, el total del pedido, las unidades
	 * y el tipo de envio.
	 * Si la sesion no existe nos llevara al login con el correspondiente mensaje de que es necesario autenticarse
	 */
	public void doGet(HttpServletRequest request,
		...
		} else { //Si la sesion existe nos mostrara la factura y un boton para terminar el pedido y completarlo
